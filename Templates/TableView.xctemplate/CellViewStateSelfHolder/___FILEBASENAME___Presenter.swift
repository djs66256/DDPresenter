...
class ___FILEBASENAME___: UITableViewCellSelfHolderStatePresenter<___VARIABLE_productName___TableCell, ___VARIABLE_productName___ViewState> {
    typealias View = ___VARIABLE_productName___TableCell
